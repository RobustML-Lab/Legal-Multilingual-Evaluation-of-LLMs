...
def calculate_average_results(file_google4, file_google_before):
    ...
    ax.set_xlabel("Metrics")
    ax.set_ylabel("Average Scores")
    ax.set_title("LLaMa Results (With Attack) for English and Non-English")
    ax.set_xticks(x)
    ax.set_xticklabels(metrics)
    ax.legend()
    plt.tight_layout()
...
# Example usage
process_and_plot_drop("Results/Eur_Lex_Sum/Run3/results_new.txt", "Results/Eur_Lex_Sum/Run4/results.txt")
calculate_average_results("Results/Eur_Lex_Sum/Run3/results_new.txt", "Results/Eur_Lex_Sum/Run4/results.txt")
